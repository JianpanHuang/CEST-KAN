...
print(device)
model = MLP(43, [100], 9)
model.load_state_dict(torch.load(r'D:\projects\CEST-KAN0725\cestkanpc10\code\kan_v3_mlp_kf_model\mlp_kf1_noise0_r4100_-1_54_1076.pth'))
model.to(device)
model.eval()
...
# Create save path
save_path = r'D:\projects\CEST-KAN0725\cestkanpc10\shap\mlp_manu\Bar_2'
