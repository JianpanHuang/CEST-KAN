...
test_targets = pd.read_csv(r'cestkanpc10\param_test_2subjects.csv', header=None)
        ...
        for k1 in [1]:  # gs
            for k2 in [5]:   #pf
                ...
                for i in range (1,repeat_model+1):  
                    ...
                    name = f"lorentkan5_kf{k_fold_id}_noise{noise}_hidden148_r{i}_{k1}_{k2}" # gamma extra   name = f"lorentzkan5_{k1}_{k2}_{i}" # gamma extra
