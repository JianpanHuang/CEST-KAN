...
data = pd.read_csv('D:\projects\cestkan\code\cestdata\zspec_train_ss10_2.csv', header=None)
print(data.shape)
targets = pd.read_csv('D:\projects\cestkan\code\cestdata\param_train_ss10_2.csv', header=None)
...
output_size = 9
hidd_layer_sz = 100
hidd_layers = [hidd_layer_sz]
# hidd_layers = [hidd_layer_sz,hidd_layer_sz,hidd_layer_sz,hidd_layer_sz]
hidd_layer_num = len(hidd_layers)
model = MLP(input_size,hidd_layers,output_size)
...
torch.save(model.state_dict(), "D:\projects\cestkan\code\model\mlp_" + str(hidd_layer_sz) + '_' + str(hidd_layer_num) + '_' + str(epoch+1) + '_' + str(int(time.time())) + ".pth")
...
torch.save(tensor_dict,"D:\projects\cestkan\code\labels\mlp_" + str(hidd_layer_sz) + '_' + str(hidd_layer_num) + '_' + str(epoch+1) + '_' + str(int(time.time())) + ".pth")
