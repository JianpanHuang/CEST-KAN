...
torch.save(model.state_dict(), "D:\CEST-KAN\model\mlp_" + str(hidd_layer_sz) + '_' + str(hidd_layer_num) + '_' + str(epoch+1) + '_' + str(int(time.time())) + ".pth")
...
torch.save(tensor_dict,"D:\CEST-KAN\modelparam\mlp_" + str(hidd_layer_sz) + '_' + str(hidd_layer_num) + '_' + str(epoch+1) + '_' + str(int(time.time())) + ".pth")
